...
class UpdatableZipFile(ZipFile):
    ...
    To enable update features use UpdatableZipFile with the 'with statement',
    ...
    def __init__(self, file, mode="r", compression=ZIP_STORED, allowZip64=False):
        # Init base
        super(UpdatableZipFile, self).__init__(
    ...
    def writestr(self, zinfo_or_arcname, bytes, compress_type=None):
        ...
        # Otherwise just act normally
            ...
            super(UpdatableZipFile, self).writestr(
    ...
    def write(self, filename, arcname=None, compress_type=None):
        ...
        # Otherwise just act normally
            ...
            super(UpdatableZipFile, self).write(
